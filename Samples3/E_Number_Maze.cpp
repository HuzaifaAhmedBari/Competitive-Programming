...
{
    io;
    vl temp1 = {1,2}, temp2 = {1,2,3}, temp3 = {1,2,3,4};
    vll perm1, perm2, perm3;
    do
    {
        perm1.push_back(temp1);
    } while (next_permutation(all(temp1)));
    do
    {
        perm2.push_back(temp2);
    } while (next_permutation(all(temp2)));
    do
    {
        perm3.push_back(temp3);
    } while (next_permutation(all(temp3)));
    ll t = 1;
    cin>>t;
    while(t--)
    {
        ...
        a--;b--;
        ll n = s.size();
        vl arr1 = x[a], arr2 = x[b];
        vb used1(n,false), used2(n,false);
        ll count=0;
        fori(0,n)
        {
            if(arr1[i]==arr2[i])
