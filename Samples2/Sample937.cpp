...
int main()
{
    ...
    while(t--)
    {
        ...
        {
            string a = bitset<64>(z).to_string().substr(((bitset<64>(z).to_string().find('1')==string::npos)? 63 : bitset<64>(z).to_string().find('1')));
            string b = bitset<64>(x).to_string().substr(((bitset<64>(x).to_string().find('1')==string::npos)? 63 : bitset<64>(x).to_string().find('1')));
            string c(b.size()-a.size(),'0');
            a = c+a;
            string s;
            fori(0,a.size())
            {
                s+= ((a[i]!=b[i] and b[i]=='1')? '1':'0');
            }
